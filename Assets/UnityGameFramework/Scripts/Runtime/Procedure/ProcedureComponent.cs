...
namespace UnityGameFramework.Runtime
{
    ...
    {
        protected IProcedureManager m_ProcedureManager = null;
        protected ProcedureBase m_EntranceProcedure = null;

        [SerializeField]
        protected string[] m_AvailableProcedureTypeNames = null;

        [SerializeField]
        protected string m_EntranceProcedureTypeName = null;
