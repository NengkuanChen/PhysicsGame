...
namespace UnityGameFramework.Runtime
{
    ...
    public partial class EntityComponent : GameFrameworkComponent
    {
        ...
        protected IEntityManager m_EntityManager = null;
        protected EventComponent m_EventComponent = null;
        ...
        /// <param name="priority">加载实体资源的优先级。</param>
        /// <param name="userData">用户自定义数据。</param>
        public virtual void ShowEntity(int entityId, Type entityLogicType, string entityAssetName, string entityGroupName, int priority, object userData)
        {
        ...
        protected virtual void OnShowEntitySuccess(object sender, GameFramework.Entity.ShowEntitySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntitySuccessEventArgs.Create(e));
        }

        protected virtual void OnShowEntityFailure(object sender, GameFramework.Entity.ShowEntityFailureEventArgs e)
        {
