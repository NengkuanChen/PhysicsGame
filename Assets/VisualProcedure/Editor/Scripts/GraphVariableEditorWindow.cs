...
//         {
//             var graphEditorWindow = GetWindow<GraphVariableEditorWindow>();
...
//
//                 for (var i = 0; i < supportTypeList.Count; i++)
//                 {
...
//             GUILayout.Space(10);
//
//             var graphEditorWindow = GraphEditorWindow.instance;
...
//             for (var i = 0; i < data.CurrentGraphVariableInfoList.Count; i++)
//             {
//                 var variableInfo = data.CurrentGraphVariableInfoList[i];
//
...
//             var typeIndex = GetTypeIndex(graphVariableInfo.valueType);
//             if (typeIndex < 0)
//             {
//                 typeIndex = 0;
...
//             {
//                 var selectedType = GetTypeAtIndex(selectIndex);
...
//
//             //变量名称
//             var valueName = graphVariableInfo.name;
//             if (valueName == null)
//             {
...
//
//             var valueType = graphVariableInfo.valueType;
//             var valueString = graphVariableInfo.valueString;
//             if (valueString == null)
//             {
...
//                 for (var j = 0; j < data.CurrentGraphVariableInfoList.Count; j++)
//                 {
//                     var assignedId = data.CurrentGraphVariableInfoList[j].id;
//
//                     if (i == assignedId)
//                     {
//                         hasAssigned = true;
