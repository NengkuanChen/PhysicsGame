...
//             var data = NodeView.graph.data;
//             var graphVariableInfo = data.GetGraphVariableInfo(variableId);
//
...
//         {
//             var labelNameWidth = labelTextStyle.CalcSize(new GUIContent(labelName)).x;
//
...
//             {
//                 var typeName = Utility.BeautifyTypeName(type) + ": ";
//                 CalculateAndDrawLabelCommonElement(typeName, 100f);
//
//                 EditorGUI.BeginChangeCheck();
//                 var value = (float) inputPortReflectionInfo.GetInputNodeVariableValue();
...
//
//                 EditorGUI.BeginChangeCheck();
//                 var value = (int) inputPortReflectionInfo.GetInputNodeVariableValue();
...
//
//                 EditorGUI.BeginChangeCheck();
//                 var value = (string) inputPortReflectionInfo.GetInputNodeVariableValue();
...
//
//                 EditorGUI.BeginChangeCheck();
//                 var value = (bool) inputPortReflectionInfo.GetInputNodeVariableValue();
...
//
//                 EditorGUI.BeginChangeCheck();
//                 var enumValue = (Enum) inputPortReflectionInfo.GetInputNodeVariableValue();
...
//                 CalculateAndDrawLabelCommonElement(typeName, 100f);
//
//                 var list = inputPortReflectionInfo.GetInputNodeVariableValue() as List<int>;
//                 if (list == null)
//                 {
//                     list = new List<int>();
//                 }
//
//                 var listHint = string.Join(",", list.Select(x => x.ToString()).ToArray());
...
//                 }
//
//                 var gameLayerNames = Utility.GetUnityLayerNames();
//
//                 var selectLayer = EditorGUI.MaskField(labelInputAreaRect, layerMaskWrapperValue.layer, gameLayerNames);
//                 if (EditorGUI.EndChangeCheck())
//                 {
...
//                 var data = GraphEditorWindow.instance.data;
//                 var graphVariableInfo = data.GetGraphVariableInfo(varibleId);
//
//                 string buttonName;
//                 //当前没有选择任何一个变量
//                 if (graphVariableInfo == null)
...
//
//                             var variableType = GraphEditorWindow.instance.data
...
//             {
//                 var typeName = Utility.BeautifyTypeName(type) + ": ";
//                 var content = string.Format("Default({0})", type.Name);
...
//         {
//             var guiStyle = Utility.GetGuiStyle("PortNameLeft");
//             var nameWidth = Utility.GetStringGuiWidth(inputPortReflectionInfo.PortName, guiStyle);
//             var typeNameWidth = Utility.GetStringGuiWidth(Utility.BeautifyTypeName(PortValueType) + "()", guiStyle);
