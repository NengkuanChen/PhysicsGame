...
//         {
//             var nodeDescriptionWindow = GetWindow<DisplayAllNodeDescriptionWindow>();
...
//             {
//                 var type = nodeTypeList[i];
//
//                 var attributeObjects = type.GetCustomAttributes(typeof(GraphNodeAttribute), false);
//                 if (attributeObjects.Length == 0)
//                 {
//                     continue;
//                 }
//
//                 var attribute = attributeObjects[0] as GraphNodeAttribute;
...
//
//             for (var i = 0; i < nodeInfoList.Count; i++)
//             {
//                 var nodeInformation = nodeInfoList[i];
//
