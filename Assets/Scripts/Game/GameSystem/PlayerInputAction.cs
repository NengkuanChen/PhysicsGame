...
public partial class @PlayerInputAction : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Editor_ChangeBallEditor = m_Editor.FindAction("ChangeBallEditor", throwIfNotFound: true);
    ...
    private readonly InputAction m_Editor_ChangeBallEditor;
    ...
    public struct EditorActions
    {
        ...
        public InputAction @ChangeBallEditor => m_Wrapper.m_Editor_ChangeBallEditor;
        ...
        public void SetCallbacks(IEditorActions instance)
        {
            ...
            {
                @ChangeBallEditor.started -= m_Wrapper.m_EditorActionsCallbackInterface.OnChangeBallEditor;
                @ChangeBallEditor.performed -= m_Wrapper.m_EditorActionsCallbackInterface.OnChangeBallEditor;
                @ChangeBallEditor.canceled -= m_Wrapper.m_EditorActionsCallbackInterface.OnChangeBallEditor;
            ...
            if (instance != null)
            {
                @ChangeBallEditor.started += instance.OnChangeBallEditor;
                @ChangeBallEditor.performed += instance.OnChangeBallEditor;
                @ChangeBallEditor.canceled += instance.OnChangeBallEditor;
    ...
    {
        void OnChangeBallEditor(InputAction.CallbackContext context);
