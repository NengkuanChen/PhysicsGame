...
public partial class @PlayerInputAction : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Player1_BallMove = m_Player1.FindAction("BallMove", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Player1_BallMove;
    public struct Player1Actions
    {
        ...
        public InputAction @BallMove => m_Wrapper.m_Player1_BallMove;
        ...
        public void SetCallbacks(IPlayer1Actions instance)
        {
            if (m_Wrapper.m_Player1ActionsCallbackInterface != null)
            {
                ...
                @BallMove.started -= m_Wrapper.m_Player1ActionsCallbackInterface.OnBallMove;
                @BallMove.performed -= m_Wrapper.m_Player1ActionsCallbackInterface.OnBallMove;
                @BallMove.canceled -= m_Wrapper.m_Player1ActionsCallbackInterface.OnBallMove;
            }
