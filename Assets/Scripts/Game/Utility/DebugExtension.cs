...
namespace Game.Utility
{
    ...
    #region DebugDrawFunctions
        ...
        /// </param>
        [Conditional("UNITY_EDITOR")]
        public static void DebugWireSphere(Vector3 position,
                                           Color color,
                                           float radius = 1.0f,
                                           float duration = 0,
                                           bool depthTest = true)
        {
            ...
            for (int i = 1; i < 37; i++)
            {
                ...
                new_y = new Vector3(position.x + radius * Mathf.Cos(angle * i * Mathf.Deg2Rad),
                    position.y,
                                     ...
                                     bool depthTest = true)
        {
            ...
            DebugExtension.DebugCircle(position + _forward,
                direction,
                color,
                (_forward - (slerpedVector.normalized * dist)).magnitude,
                duration,
                depthTest);
            DebugExtension.DebugCircle(position + (_forward * 0.5f),
                direction,
                color,
        ...
        /// </param>
        [Conditional("UNITY_EDITOR")]
        public static void DebugArrow(Vector3 position,
                                      Vector3 direction,
                                      Color color,
                                      float duration = 0,
                                      bool depthTest = true)
    ...
    #region GizmoDrawFunctions
        ...
        /// </param>
        [Conditional("UNITY_EDITOR")]
        public static void DrawLocalCube(Transform transform,
                                         Vector3 size,
                                         Color color,
                                         Vector3 center = default(Vector3))
        {
        ...
        [Conditional("UNITY_EDITOR")]
        public static void DrawLocalFillCube(Transform transform, Vector3 size, Color color)
        {
            Color oldColor = Gizmos.color;
        ...
        public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45)
        {
            ...
            DebugExtension.DrawCircle(position + _forward,
                direction,
                color,
                (_forward - (slerpedVector.normalized * dist)).magnitude);
            DebugExtension.DrawCircle(position + (_forward * 0.5f),
                direction,
                color,
                ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude);
        ...
        {
            DrawText(text, position, 24, Color.white);
        }

        [Conditional("UNITY_EDITOR")]
        public static void DrawText(string text, Vector3 position, Color color)
        {
            DrawText(text, position, 24, color);
        }

        [Conditional("UNITY_EDITOR")]
        public static void DrawText(string text, Vector3 position, int textSize)
        {
            DrawText(text, position, textSize, Color.white);
        }

        [Conditional("UNITY_EDITOR")]
        public static void DrawText(string text, Vector3 position, int textSize, Color color)
        {
        #if UNITY_EDITOR
            var guiContent = new GUIContent(text);
            var guiStyle = new GUIStyle("BoldLabel");
            guiStyle.alignment = TextAnchor.MiddleCenter;
            guiStyle.fontSize = textSize;
            guiStyle.normal.textColor = color;
            Handles.Label(position, guiContent, guiStyle);
        #endif
        }
